...
(define-method (dump (o <component>))
  (let ((name (.name o))
    ...
    (dump-indented (symbol-append 'component- name '-c3.hh)
                   (lambda ()
                     ((animate-template 'component.c3.hh.scm) (python-module o))))
    (if (.behaviour o)
        (dump-indented (symbol-append 'component- name '-c3.cc)
                       (lambda ()
                         ((animate-template 'component.c3.cc.scm) (python-module o))))
        (dump-indented (symbol-append 'glue-component- name '-c3.cc)
                       (lambda ()
                         ((animate-template 'glue-bottom-component.c3.cc.scm) (python-module o)))))))
...
(define-method (dump (o <system>))
  (let ((name (.name o))
    ...
    (dump-indented (symbol-append 'component- name '-c3.hh)
                   (lambda ()
                     ((animate-template 'system.c3.hh.scm) (python-module o))))
    (dump-indented (symbol-append 'component- name '-c3.cc)
                   (lambda ()
                     ((animate-template 'system.c3.cc.scm) (python-module o))))
    (dump-indented (symbol-append name 'Interface.h)
                   (lambda ()
                     ((animate-template 'glue-top-system-interface.c3.hh.scm) (python-module o))))
    (dump-indented (symbol-append name 'Component.h)
                   (lambda ()
                     ((animate-template 'glue-top-system.c3.hh.scm) (python-module o))))
    (dump-indented (symbol-append name 'Component.cpp)
                   (lambda ()
                     ((animate-template 'glue-top-system.c3.cc.scm) (python-module o))))))
