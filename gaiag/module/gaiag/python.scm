    ...
    (->string
     (match src
       ...
       (($ <assign> name (and ($ <action>) (get! action)))
        (list space "self." name " = " (statements->string model (action) locals indent)))
       (($ <assign> identifier expression)
        (list space "self." (statements->string model identifier locals indent) " = " (expression->string model expression locals) "\n"))
       ...
       (($ <variable> name type (and ($ <action>) (get! action)))
        (statements->string model (list name " = " (statements->string model (action))) locals indent))
       (($ <variable> name type expression)
        (statements->string model (list name " = " (expression->string model expression locals) ";\n") locals indent))
...
(define* (expression->string model o :optional (locals '()))
  ...
  (match o
    ...
    (($ <var> identifier) (list "self." identifier))
    (($ <field> identifier field)
