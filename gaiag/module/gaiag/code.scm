...
(define ((declare-io model snippet) event)
  (let* ((name (.name event))
    ...
    (animate snippet `((name ,name) (comma ,comma) (comma-space ,comma-space) (parameters ,parameters) (parameter-list ,parameter-list) (parameter-types ,parameter-types) (return-type ,return-type)))))
