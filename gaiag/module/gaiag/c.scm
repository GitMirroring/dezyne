...
(define-method (dump (o <interface>))
  (let ((name (.name o)))
    (dump-indented (symbol-append name '.h)
                   (lambda ()
                     (c-file 'interface.h.scm (code:module o))))))
...
(define-method (dump (o <component>))
  (let ((name (.name o))
    ...
    (dump-indented (symbol-append name '.h)
                   (lambda ()
                     (c-file 'component.h.scm (code:module o))))
    (if (.behaviour o)
        (dump-indented (symbol-append name '.c)
                       (lambda ()
                         (c-file 'component.c.scm (code:module o)))))))
...
(define-method (dump (o <system>))
  (let ((name (.name o))
    ...
    (dump-indented (symbol-append name '.h)
                   (lambda ()
                     (c-file 'system.h.scm (code:module o))))
    (dump-indented (symbol-append name '.c)
                   (lambda ()
                     (c-file 'system.c.scm (code:module o))))))
