...
(define (->string o)
  ...
  (match o
    ...
    (($ <literal> ('name '*global* name) field) ((->join ".") (list name field)))
    (($ <literal> ('name scope ...) field)
     ((->join ".") (append scope (list field)))) ;; TODO: local/namespace
...
(define dezyne-templates
  `((component . ((name . ,->string)
    ...
    (system . ((name . ,->string)
               ...
               (instances . ,->string)
               (bindings . ,->string)))
    (system-as-component . ((name . ,->string)
                            (ports . ,->string)
                            (instances . ,->string)
                            (bindings . ,->string)))
