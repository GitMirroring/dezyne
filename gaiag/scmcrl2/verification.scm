...
(define ((mcrl2:verify-interface-deadlock model) dir file-name ast verbose? all?)
  (let* ((model-name ((compose ->string verify:scope-name) model))
 	 (foo (assert-start 'interface model-name 'deadlock verbose?))
         (commands `(("echo" "-e" ,(string-drop-right (string-drop (mcrl2:init model 'interface-init@ast) 1) 1))
                     ("cat" "verify.mcrl2" "-")
                     ("mcrl22lps" "--quiet" "-b")
...
(define ((mcrl2:verify-component-deterministic model) dir file-name ast verbose? all?)
  (let* ((model-name ((compose ->string verify:scope-name) model))
 	 (foo (assert-start 'component model-name 'deadlock verbose?))
         (commands `(("echo" "-e" ,(string-drop-right (string-drop (mcrl2:init model 'determinism-init@ast) 1) 1))
                     ("cat" "verify.mcrl2" "-")
                     ("tee" "0.mcrll2")
                     ("mcrl22lps" "--quiet" "-b")
                     ("lpsconstelm" "--quiet" "-st")
...
(define ((mcrl2:verify-component-deadlock model) dir file-name ast verbose? all?)
  (let* ((model-name ((compose ->string verify:scope-name) model))
 	 (foo (assert-start 'component model-name 'deadlock verbose?))
         (commands `(("echo" "-e" ,(string-drop-right (string-drop (mcrl2:init ast 'component-deadlock-init@ast) 1) 1))
                     ("cat" "-" "verify.mcrl2")
                     ("mcrl22lps" "--quiet" "-b")
                     ("lpsconstelm" "--quiet" "-st")
                     ("lpsparelm")
...
(define ((mcrl2:verify-component-refinement model) dir file-name ast verbose? all?)
  (let* ((model-name ((compose ->string verify:scope-name) model))
 	 (foo (assert-start 'component model-name 'compliance verbose?))
         ...
         (commands `(("echo" "-e" ,(string-drop-right (string-drop (mcrl2:init ast 'compliance-init@ast) 1) 1))
                     ("cat" "verify.mcrl2" "-")
                     ("mcrl22lps" "--quiet" "-b")
                     ("lpsconstelm" "--quiet" "-st")
                     ("lpsparelm")
