...
(define (tree:trigger-names o)
  (cond ((slot o 'interface) (tree:event-names o 'in))
        ((slot o 'component) (tree:port-event-names o 'trigger))
        (else '())))

(define (tree:action-names o)
  (cond ((slot o 'interface) (tree:event-names o 'out))
        ((slot o 'component) (tree:port-event-names o 'action))
        (else '())))
