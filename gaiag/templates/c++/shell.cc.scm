...
#port .#direction .#event  = [&] (#formals) {
    return dzn::shell(dzn_pump, [&#comma #capture-list] {return #instance .#instance-port .#direction .#event(#arguments);});
};
...
(map
    (lambda (port)
      (map (define-on model port #{
#port .#direction .#event  = [&] (#formals) {
    return dzn_pump([&#comma #capture-list] {return #instance .#instance-port .#direction .#event(#arguments);});
};
