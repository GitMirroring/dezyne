...
(define-templates queue-proc-requires ast:requires-ports newline-union-infix)
(define-templates queue-comm-requires ast:requires-ports newline-comma-infix)
(define-templates queue-allow-requires ast:requires-ports newline-comma-infix)
(define-templates queue-rename-requires ast:requires-ports newline-comma-infix)
(define-templates queue-hide-requires ast:requires-ports newline-comma-infix)
...
(define-templates reorder-allow-requires ast:requires-ports newline-comma-prefix)
(define-templates reorder-rename-provides ast:provides-ports newline-comma-prefix)
(define-templates reorder-rename-requires ast:requires-ports newline-comma-prefix)
(define-templates reorder-hide-provides ast:provides-ports newline-comma-infix)
...
(define-templates semantics-provides-blocked ast:requires-ports newline-union-prefix)
(define-templates semantics-provides-blocked-qmt ast:requires-ports newline-union-prefix)
(define-templates semantics-provides-replies makreel:provides-replies newline-union-prefix)
...
(define-templates semantics-comm-requires ast:requires-ports newline-comma-prefix)
(define-templates semantics-allow-provides ast:provides-ports newline-comma-prefix)
(define-templates semantics-allow-requires ast:requires-ports newline-comma-prefix)
(define-templates semantics-rename-provides ast:provides-ports newline-comma-prefix)
(define-templates semantics-rename-requires ast:requires-ports newline-comma-prefix)

;; component
(define-templates component-comm-requires ast:requires-ports newline-comma-prefix)
...
(define-templates component-rename-requires ast:requires-ports newline-comma-prefix)
...
(define-templates provides-allow ast:provides-ports newline-comma-infix)
