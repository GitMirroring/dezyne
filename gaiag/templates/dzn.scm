...
(define-templates model-name (compose om:name (lambda (o) (parent <model> o))))
...
(define-templates trigger-signature (lambda (o) (if (not (.port o)) "" o)))
...
(define-templates instance (lambda (o) (if (not (.instance o)) "" (list (.instance o)))) dot-suffix)
