...
(define-templates header-model (lambda (o) (topological-sort (map dzn:annotate-shells (filter (negate (disjoin om:imported? (is? <type>) (is? <interface>) dzn-async?)) (.elements o))))))
