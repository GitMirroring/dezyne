...
(define-templates reply-union (lambda (o) (if (parent o <component>) o "")))
(define-templates reply-selector (lambda (o) (if (parent o <component>) o "")))
...
(define-templates provided-port-reply-types)
...
(define-templates action-union-struct (lambda (o) (if (null? (om:required o)) "NoActionsPresent" (om:required o))) pipe-infix)
(define-templates all-reply-union-struct om:provided pipe-infix)
...
;;(define-templates mcrl2-run2completion-provided-port om:provided union-infix)
(define-templates component-r2c)
(define-templates component-r2c-provided om:provided union-newline-infix)
(define-templates component-r2c-required om:required union-newline-prefix)
(define-templates component-r2c-handling-provided om:provided union-newline-infix)
(define-templates component-r2c-handling-required om:required union-newline-prefix)
(define-templates mcrl2-implementation)
(define-templates mcrl2-component-queues)
(define-templates specification)
(define-templates specification-r2c-provided om:provided union-newline-infix)
(define-templates specification-r2c-event-provided om:provided union-newline-infix)
(define-templates specification-r2c-modeling-provided om:provided union-newline-infix)
(define-templates specification-rename-provided om:provided comma-newline-infix)
(define-templates specification-allow-provided om:provided comma-newline-infix)
(define-templates specification-comm-provided om:provided comma-newline-infix)
(define-templates specification-parallel-provided om:provided parallel-newline-suffix)
...
(define-templates provided-port-queue om:provided union-suffix)
...
;;(define-templates mcrl2-component-rc-provided-port om:provided newline-infix)
;;(define-templates mcrl2-required-with-out-event required-ports-with-out)
;;(define-templates required-ports-run2completion (lambda (o) (if (pair? (required-ports-with-out o)) (om:provided (parent o <model>)) "delta")) union-infix)
...
(define-templates provided-port-allowed-parallel-actions om:provided comma-infix)
...
(define-templates provided-port-communicated-allowed-parallel-actions om:provided comma-infix)
...
(define-templates provided-port-allowed-communicated-allowed-parallel-actions om:provided comma-infix)
...
(define-templates eqn-allow-dillegals-provided (lambda (o) (om:provided (car (filter (is? <component>) (.elements (parent o <root>)))))))
(define-templates compliance-init-rename (lambda (o) (om:provided (car (filter (is? <component>) (.elements (parent o <root>)))))) comma-infix)
