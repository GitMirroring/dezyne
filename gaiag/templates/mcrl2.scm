...
(define-templates reply-union (lambda (o) (if (parent <component> o) o "")))
(define-templates reply-selector (lambda (o) (if (parent <component> o) o "")))
...
;;(define-templates required-ports-run2completion (lambda (o) (if (pair? (required-ports-with-out o)) (om:provided (parent <model> o)) "delta")) union-infix)
...
(define-templates compliance-init-rename (lambda (o) (om:provided (car (filter (is? <component>) (.elements (parent <root> o)))))) comma-infix)
