...
(define ((state->value model) o)
  (match o
    ((and ($ <field-test>) (= .field (and (? number?) (get! number)))) (number))
    ((and ($ <field-test>) (= .field (and (or 'true 'false) (get! bool)))) (bool))
...
(define ((json-table-state model) o)
  (match o
    ...
    ((and ($ <guard>) (= .expression expression) (= .statement (and ($ <on>) (get! on))))
     (let ((var (state-var model expression)))
  ...
  (let ((unknown (make <field-test> #:variable (variable var) #:field '<unknown>)))
   (match o
     ...
     ((and ($ <assign>) (= .variable (? var?)) (= .expression ($ <call>)))
      (list unknown))
     ((and ($ <assign>) (= .variable (? var?)) (= .expression expression))
