...
namespace dezyne
{
  Reply::Reply(const locator& dezyne_locator)
  : dzn_meta{"","Reply",reinterpret_cast<const component*>(this),0,{},{[this]{i.check_bindings();},[this]{u.check_bindings();}}}
  ...
  void Reply::check_bindings() const
  {
    dezyne::check_bindings(reinterpret_cast<const dezyne::component*>(this));
  }
  void Reply::dump_tree() const
  {
