...
namespace component
{
  ...
  , u()
  {
    i.in.done = dezyne::connect<interface::I::Status::type>(rt, this, dezyne::function<interface::I::Status::type()>(dezyne::bind<interface::I::Status::type>(&Reply4::i_done, this)));
  }

  interface::I::Status::type Reply4::i_done()
  {
