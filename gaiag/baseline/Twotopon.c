...
static void call_in_i_e(ITwotopon* self) {
...
static void call_in_i_t(ITwotopon* self) {
...
void Twotopon_init (Twotopon* self, locator* dezyne_locator, dzn_meta_t *dzn_meta) {
