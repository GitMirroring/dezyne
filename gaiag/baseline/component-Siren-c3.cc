...
namespace component
{
  ...
  , siren()
  {
    siren.in.turnon = dezyne::connect_in<void>(rt, this, dezyne::bind<void>(&Siren::siren_turnon, this));
    siren.in.turnoff = dezyne::connect_in<void>(rt, this, dezyne::bind<void>(&Siren::siren_turnoff, this));
  }
