...
#ifndef IBLOCKDATA2B_HH
#define IBLOCKDATA2B_HH
...
struct iblockdata2b
{
  ...
  inline iblockdata2b(dezyne::port::meta m) : meta(m) {}
...
inline void connect (iblockdata2b& provided, iblockdata2b& required)
{
