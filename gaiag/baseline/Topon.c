...
typedef struct {int size;void (*f)(ITopon*);Topon* self;} args_i_a;


typedef struct {int size;void (*f)(Topon*);Topon* self;} args_i_e;
typedef struct {int size;void (*f)(Topon*);Topon* self;} args_i_t;
