...
namespace component
{
  incomplete_with_modeling_event::incomplete_with_modeling_event()
  : p()
  , r()
  {
    p.in.e = connect<void>(this, asd::bind<void>(&incomplete_with_modeling_event::p_e, this));
    r.out.a = connect<void>(this, asd::bind<void>(&incomplete_with_modeling_event::r_a, this));
  }
