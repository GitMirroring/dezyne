...
namespace component
{
  ...
  , po_u()
  {
    po_i.in.done = connect<interface::I::Status::type>(this, asd::bind<interface::I::Status::type>(&Reply::po_i_done, this));
  }

  interface::I::Status::type Reply::po_i_done()
  {
    std::cout << "Reply.po_i_done" << std::endl;
    if (true)
