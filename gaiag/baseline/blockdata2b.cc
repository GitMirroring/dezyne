...
blockdata2b::blockdata2b(const dezyne::locator& dezyne_locator)
: dzn_meta{"","blockdata2b",reinterpret_cast<const dezyne::component*>(this),0,{},{[this]{p1.check_bindings();},[this]{p2.check_bindings();}}}
...
Bool::type blockdata2b::p1_b(int& s)
{
  this->out_p1 = [&] {
    s = this->global_status;
  };
  {
    int& status = s;
    this->p1.out.a();
...
void blockdata2b::p1_success(int s)
{
  {
    int x = s;
    {
...
void blockdata2b::p1_fail(int status)
{
  {
    int x = status;
    {
...
Bool::type blockdata2b::p2_b(int& s)
{
  {
    int& x = s;
    this->p2.out.a();
...
void blockdata2b::p2_success(int s)
{
  {
    int status = s;
...
void blockdata2b::p2_fail(int status)
{
...
void blockdata2b::check_bindings() const
{
  dezyne::check_bindings(reinterpret_cast<const dezyne::component*>(this));
}
void blockdata2b::dump_tree() const
{
