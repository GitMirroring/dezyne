...
, u()
{
  i.in.done = dezyne::connect<I::Status::type>(rt, this, dezyne::function<I::Status::type()>(dezyne::bind<I::Status::type>(&Reply2::i_done, this)));
}

I::Status::type Reply2::i_done()
{
  std::cout << "Reply2.i_done" << std::endl;
  if (true)
  {
    {
