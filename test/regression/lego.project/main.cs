...
class main {
  ...
  private static EventMap fillEventMap(LegoBallSorter m) {
    ...
    m.brick1_aA.inport.move = (uint8_t power, int32_t position) => {log_in("brick1_aA.", "move", e);};
    m.brick1_aA.inport.run = (uint8_t power, bool invert) => {log_in("brick1_aA.", "run", e);};
    ...
    m.brick1_aA.inport.position = (V<int32_t> pos) => {log_in("brick1_aA.", "position", e);};
    m.brick1_aA.inport.at = (int32_t pos) => {return log_valued<imotor.result_t>("brick1_aA.", "at", e, "brick1_aA.result_t_");};
    m.brick1_aB.inport.move = (uint8_t power, int32_t position) => {log_in("brick1_aB.", "move", e);};
    m.brick1_aB.inport.run = (uint8_t power, bool invert) => {log_in("brick1_aB.", "run", e);};
    ...
    m.brick1_aB.inport.position = (V<int32_t> pos) => {log_in("brick1_aB.", "position", e);};
    m.brick1_aB.inport.at = (int32_t pos) => {return log_valued<imotor.result_t>("brick1_aB.", "at", e, "brick1_aB.result_t_");};
    m.brick1_aC.inport.move = (uint8_t power, int32_t position) => {log_in("brick1_aC.", "move", e);};
    m.brick1_aC.inport.run = (uint8_t power, bool invert) => {log_in("brick1_aC.", "run", e);};
    ...
    m.brick1_aC.inport.position = (V<int32_t> pos) => {log_in("brick1_aC.", "position", e);};
    m.brick1_aC.inport.at = (int32_t pos) => {return log_valued<imotor.result_t>("brick1_aC.", "at", e, "brick1_aC.result_t_");};
    ...
    m.brick2_aA.inport.move = (uint8_t power, int32_t position) => {log_in("brick2_aA.", "move", e);};
    m.brick2_aA.inport.run = (uint8_t power, bool invert) => {log_in("brick2_aA.", "run", e);};
    ...
    m.brick2_aA.inport.position = (V<int32_t> pos) => {log_in("brick2_aA.", "position", e);};
    m.brick2_aA.inport.at = (int32_t pos) => {return log_valued<imotor.result_t>("brick2_aA.", "at", e, "brick2_aA.result_t_");};
    m.brick2_aB.inport.move = (uint8_t power, int32_t position) => {log_in("brick2_aB.", "move", e);};
    m.brick2_aB.inport.run = (uint8_t power, bool invert) => {log_in("brick2_aB.", "run", e);};
    ...
    m.brick2_aB.inport.position = (V<int32_t> pos) => {log_in("brick2_aB.", "position", e);};
    m.brick2_aB.inport.at = (int32_t pos) => {return log_valued<imotor.result_t>("brick2_aB.", "at", e, "brick2_aB.result_t_");};
    ...
    m.brick3_aA.inport.move = (uint8_t power, int32_t position) => {log_in("brick3_aA.", "move", e);};
    m.brick3_aA.inport.run = (uint8_t power, bool invert) => {log_in("brick3_aA.", "run", e);};
    ...
    m.brick3_aA.inport.position = (V<int32_t> pos) => {log_in("brick3_aA.", "position", e);};
    m.brick3_aA.inport.at = (int32_t pos) => {return log_valued<imotor.result_t>("brick3_aA.", "at", e, "brick3_aA.result_t_");};
    m.brick3_aC.inport.move = (uint8_t power, int32_t position) => {log_in("brick3_aC.", "move", e);};
    m.brick3_aC.inport.run = (uint8_t power, bool invert) => {log_in("brick3_aC.", "run", e);};
    ...
    m.brick3_aC.inport.position = (V<int32_t> pos) => {log_in("brick3_aC.", "position", e);};
    m.brick3_aC.inport.at = (int32_t pos) => {return log_valued<imotor.result_t>("brick3_aC.", "at", e, "brick3_aC.result_t_");};
    ...
    m.brick4_aA.inport.move = (uint8_t power, int32_t position) => {log_in("brick4_aA.", "move", e);};
    m.brick4_aA.inport.run = (uint8_t power, bool invert) => {log_in("brick4_aA.", "run", e);};
    ...
    m.brick4_aA.inport.position = (V<int32_t> pos) => {log_in("brick4_aA.", "position", e);};
    m.brick4_aA.inport.at = (int32_t pos) => {return log_valued<imotor.result_t>("brick4_aA.", "at", e, "brick4_aA.result_t_");};
    m.brick4_aB.inport.move = (uint8_t power, int32_t position) => {log_in("brick4_aB.", "move", e);};
    m.brick4_aB.inport.run = (uint8_t power, bool invert) => {log_in("brick4_aB.", "run", e);};
    ...
    m.brick4_aB.inport.position = (V<int32_t> pos) => {log_in("brick4_aB.", "position", e);};
    m.brick4_aB.inport.at = (int32_t pos) => {return log_valued<imotor.result_t>("brick4_aB.", "at", e, "brick4_aB.result_t_");};
    m.brick4_aC.inport.move = (uint8_t power, int32_t position) => {log_in("brick4_aC.", "move", e);};
    m.brick4_aC.inport.run = (uint8_t power, bool invert) => {log_in("brick4_aC.", "run", e);};
    ...
    m.brick4_aC.inport.position = (V<int32_t> pos) => {log_in("brick4_aC.", "position", e);};
    m.brick4_aC.inport.at = (int32_t pos) => {return log_valued<imotor.result_t>("brick4_aC.", "at", e, "brick4_aC.result_t_");};
