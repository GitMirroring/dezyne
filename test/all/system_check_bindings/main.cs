...
class main
{
  ...
  public static void Main (String[] args)
  {
    ...
    var unbound_in_event = new system_check_bindings (locator, "unbound_in_event");
    ...
    var unbound_out_event = new system_check_bindings (locator, "unbound_out_event");
    ...
    var no_unbound_events = new system_check_bindings (locator, "no_unbound_events");
