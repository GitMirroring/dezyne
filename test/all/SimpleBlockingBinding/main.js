...
dzn.extend (dzn, require (__dirname + '/dzn/SimpleBlockingBinding'));
...
function SimpleBlockingBinding_fill_event_map(m)
{
...
function main () {
  ...
  var sut = new dzn.SimpleBlockingBinding(loc.set(rt), {name:'sut'});

  var event_map = SimpleBlockingBinding_fill_event_map(sut);
