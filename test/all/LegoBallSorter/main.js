...
function log_typed(prefix, event, event_map, string_to_value, value_to_string) {
  console.error(prefix + event);
  if (relaxed) return 0;
...
function LegoBallSorter_fill_event_map(m)
{
  ...
  m.brick1_aA.in.at = function() {return log_typed('brick1_aA.', 'at', e, function(s) {return new dzn.imotor().result_t[drop_prefix(s, 'brick1_aA.result_t_')];}, new dzn.imotor().result_t_to_string)};
  ...
  m.brick1_aB.in.at = function() {return log_typed('brick1_aB.', 'at', e, function(s) {return new dzn.imotor().result_t[drop_prefix(s, 'brick1_aB.result_t_')];}, new dzn.imotor().result_t_to_string)};
  ...
  m.brick1_aC.in.at = function() {return log_typed('brick1_aC.', 'at', e, function(s) {return new dzn.imotor().result_t[drop_prefix(s, 'brick1_aC.result_t_')];}, new dzn.imotor().result_t_to_string)};
  m.brick1_s1.in.detect = function() {return log_typed('brick1_s1.', 'detect', e, function(s) {return new dzn.itouch().status[drop_prefix(s, 'brick1_s1.status_')];}, new dzn.itouch().status_to_string)};
  m.brick1_s2.in.detect = function() {return log_typed('brick1_s2.', 'detect', e, function(s) {return new dzn.itouch().status[drop_prefix(s, 'brick1_s2.status_')];}, new dzn.itouch().status_to_string)};
  m.brick1_s3.in.detect = function() {return log_typed('brick1_s3.', 'detect', e, function(s) {return new dzn.itouch().status[drop_prefix(s, 'brick1_s3.status_')];}, new dzn.itouch().status_to_string)};
  m.brick1_s4.in.detect = function() {return log_typed('brick1_s4.', 'detect', e, function(s) {return new dzn.itouch().status[drop_prefix(s, 'brick1_s4.status_')];}, new dzn.itouch().status_to_string)};
  ...
  m.brick2_aA.in.at = function() {return log_typed('brick2_aA.', 'at', e, function(s) {return new dzn.imotor().result_t[drop_prefix(s, 'brick2_aA.result_t_')];}, new dzn.imotor().result_t_to_string)};
  ...
  m.brick2_aB.in.at = function() {return log_typed('brick2_aB.', 'at', e, function(s) {return new dzn.imotor().result_t[drop_prefix(s, 'brick2_aB.result_t_')];}, new dzn.imotor().result_t_to_string)};
  m.brick2_s2.in.detect = function() {return log_typed('brick2_s2.', 'detect', e, function(s) {return new dzn.itouch().status[drop_prefix(s, 'brick2_s2.status_')];}, new dzn.itouch().status_to_string)};
  m.brick2_s3.in.detect = function() {return log_typed('brick2_s3.', 'detect', e, function(s) {return new dzn.itouch().status[drop_prefix(s, 'brick2_s3.status_')];}, new dzn.itouch().status_to_string)};
  m.brick2_s4.in.detect = function() {return log_typed('brick2_s4.', 'detect', e, function(s) {return new dzn.itouch().status[drop_prefix(s, 'brick2_s4.status_')];}, new dzn.itouch().status_to_string)};
  ...
  m.brick3_aA.in.at = function() {return log_typed('brick3_aA.', 'at', e, function(s) {return new dzn.imotor().result_t[drop_prefix(s, 'brick3_aA.result_t_')];}, new dzn.imotor().result_t_to_string)};
  ...
  m.brick3_aC.in.at = function() {return log_typed('brick3_aC.', 'at', e, function(s) {return new dzn.imotor().result_t[drop_prefix(s, 'brick3_aC.result_t_')];}, new dzn.imotor().result_t_to_string)};
  m.brick3_s1.in.turnon = function() {log_in('brick3_s1.', 'turnon', e);};
  m.brick3_s1.in.turnoff = function() {log_in('brick3_s1.', 'turnoff', e);};
  m.brick3_s1.in.detect = function() {return log_typed('brick3_s1.', 'detect', e, function(s) {return new dzn.ilight().status[drop_prefix(s, 'brick3_s1.status_')];}, new dzn.ilight().status_to_string)};
  m.brick3_s2.in.detect = function() {return log_typed('brick3_s2.', 'detect', e, function(s) {return new dzn.itouch().status[drop_prefix(s, 'brick3_s2.status_')];}, new dzn.itouch().status_to_string)};
  m.brick3_s3.in.detect = function() {return log_typed('brick3_s3.', 'detect', e, function(s) {return new dzn.itouch().status[drop_prefix(s, 'brick3_s3.status_')];}, new dzn.itouch().status_to_string)};
  ...
  m.brick4_aA.in.at = function() {return log_typed('brick4_aA.', 'at', e, function(s) {return new dzn.imotor().result_t[drop_prefix(s, 'brick4_aA.result_t_')];}, new dzn.imotor().result_t_to_string)};
  ...
  m.brick4_aB.in.at = function() {return log_typed('brick4_aB.', 'at', e, function(s) {return new dzn.imotor().result_t[drop_prefix(s, 'brick4_aB.result_t_')];}, new dzn.imotor().result_t_to_string)};
  ...
  m.brick4_aC.in.at = function() {return log_typed('brick4_aC.', 'at', e, function(s) {return new dzn.imotor().result_t[drop_prefix(s, 'brick4_aC.result_t_')];}, new dzn.imotor().result_t_to_string)};
  m.brick4_s1.in.detect = function() {return log_typed('brick4_s1.', 'detect', e, function(s) {return new dzn.itouch().status[drop_prefix(s, 'brick4_s1.status_')];}, new dzn.itouch().status_to_string)};
  m.brick4_s2.in.detect = function() {return log_typed('brick4_s2.', 'detect', e, function(s) {return new dzn.itouch().status[drop_prefix(s, 'brick4_s2.status_')];}, new dzn.itouch().status_to_string)};
  m.brick4_s3.in.detect = function() {return log_typed('brick4_s3.', 'detect', e, function(s) {return new dzn.itouch().status[drop_prefix(s, 'brick4_s3.status_')];}, new dzn.itouch().status_to_string)};
  return e;
}
