...
def LegoBallSorter_fill_event_map (m):
    ...
    m.brick1_aA.inport.at = lambda *args: log_valued ('brick1_aA.', 'at', e, lambda s: dzn.imotor.result_t.__dict__.get (drop_prefix(s, 'brick1_aA.result_t_'), None), dzn.imotor.result_t_to_string)
    ...
    m.brick1_aB.inport.at = lambda *args: log_valued ('brick1_aB.', 'at', e, lambda s: dzn.imotor.result_t.__dict__.get (drop_prefix(s, 'brick1_aB.result_t_'), None), dzn.imotor.result_t_to_string)
    ...
    m.brick1_aC.inport.at = lambda *args: log_valued ('brick1_aC.', 'at', e, lambda s: dzn.imotor.result_t.__dict__.get (drop_prefix(s, 'brick1_aC.result_t_'), None), dzn.imotor.result_t_to_string)
    m.brick1_s1.inport.detect = lambda *args: log_valued ('brick1_s1.', 'detect', e, lambda s: dzn.itouch.status.__dict__.get (drop_prefix(s, 'brick1_s1.status_'), None), dzn.itouch.status_to_string)
    m.brick1_s2.inport.detect = lambda *args: log_valued ('brick1_s2.', 'detect', e, lambda s: dzn.itouch.status.__dict__.get (drop_prefix(s, 'brick1_s2.status_'), None), dzn.itouch.status_to_string)
    m.brick1_s3.inport.detect = lambda *args: log_valued ('brick1_s3.', 'detect', e, lambda s: dzn.itouch.status.__dict__.get (drop_prefix(s, 'brick1_s3.status_'), None), dzn.itouch.status_to_string)
    m.brick1_s4.inport.detect = lambda *args: log_valued ('brick1_s4.', 'detect', e, lambda s: dzn.itouch.status.__dict__.get (drop_prefix(s, 'brick1_s4.status_'), None), dzn.itouch.status_to_string)
    ...
    m.brick2_aA.inport.at = lambda *args: log_valued ('brick2_aA.', 'at', e, lambda s: dzn.imotor.result_t.__dict__.get (drop_prefix(s, 'brick2_aA.result_t_'), None), dzn.imotor.result_t_to_string)
    ...
    m.brick2_aB.inport.at = lambda *args: log_valued ('brick2_aB.', 'at', e, lambda s: dzn.imotor.result_t.__dict__.get (drop_prefix(s, 'brick2_aB.result_t_'), None), dzn.imotor.result_t_to_string)
    m.brick2_s2.inport.detect = lambda *args: log_valued ('brick2_s2.', 'detect', e, lambda s: dzn.itouch.status.__dict__.get (drop_prefix(s, 'brick2_s2.status_'), None), dzn.itouch.status_to_string)
    m.brick2_s3.inport.detect = lambda *args: log_valued ('brick2_s3.', 'detect', e, lambda s: dzn.itouch.status.__dict__.get (drop_prefix(s, 'brick2_s3.status_'), None), dzn.itouch.status_to_string)
    m.brick2_s4.inport.detect = lambda *args: log_valued ('brick2_s4.', 'detect', e, lambda s: dzn.itouch.status.__dict__.get (drop_prefix(s, 'brick2_s4.status_'), None), dzn.itouch.status_to_string)
    ...
    m.brick3_aA.inport.at = lambda *args: log_valued ('brick3_aA.', 'at', e, lambda s: dzn.imotor.result_t.__dict__.get (drop_prefix(s, 'brick3_aA.result_t_'), None), dzn.imotor.result_t_to_string)
    ...
    m.brick3_aC.inport.at = lambda *args: log_valued ('brick3_aC.', 'at', e, lambda s: dzn.imotor.result_t.__dict__.get (drop_prefix(s, 'brick3_aC.result_t_'), None), dzn.imotor.result_t_to_string)
    ...
    m.brick3_s1.inport.detect = lambda *args: log_valued ('brick3_s1.', 'detect', e, lambda s: dzn.ilight.status.__dict__.get (drop_prefix(s, 'brick3_s1.status_'), None), dzn.ilight.status_to_string)
    m.brick3_s2.inport.detect = lambda *args: log_valued ('brick3_s2.', 'detect', e, lambda s: dzn.itouch.status.__dict__.get (drop_prefix(s, 'brick3_s2.status_'), None), dzn.itouch.status_to_string)
    m.brick3_s3.inport.detect = lambda *args: log_valued ('brick3_s3.', 'detect', e, lambda s: dzn.itouch.status.__dict__.get (drop_prefix(s, 'brick3_s3.status_'), None), dzn.itouch.status_to_string)
    ...
    m.brick4_aA.inport.at = lambda *args: log_valued ('brick4_aA.', 'at', e, lambda s: dzn.imotor.result_t.__dict__.get (drop_prefix(s, 'brick4_aA.result_t_'), None), dzn.imotor.result_t_to_string)
    ...
    m.brick4_aB.inport.at = lambda *args: log_valued ('brick4_aB.', 'at', e, lambda s: dzn.imotor.result_t.__dict__.get (drop_prefix(s, 'brick4_aB.result_t_'), None), dzn.imotor.result_t_to_string)
    ...
    m.brick4_aC.inport.at = lambda *args: log_valued ('brick4_aC.', 'at', e, lambda s: dzn.imotor.result_t.__dict__.get (drop_prefix(s, 'brick4_aC.result_t_'), None), dzn.imotor.result_t_to_string)
    m.brick4_s1.inport.detect = lambda *args: log_valued ('brick4_s1.', 'detect', e, lambda s: dzn.itouch.status.__dict__.get (drop_prefix(s, 'brick4_s1.status_'), None), dzn.itouch.status_to_string)
    m.brick4_s2.inport.detect = lambda *args: log_valued ('brick4_s2.', 'detect', e, lambda s: dzn.itouch.status.__dict__.get (drop_prefix(s, 'brick4_s2.status_'), None), dzn.itouch.status_to_string)
    m.brick4_s3.inport.detect = lambda *args: log_valued ('brick4_s3.', 'detect', e, lambda s: dzn.itouch.status.__dict__.get (drop_prefix(s, 'brick4_s3.status_'), None), dzn.itouch.status_to_string)
    return e
...
def main ():
    ...
    sut = dzn.LegoBallSorter (loc.set (rt), name='sut')
