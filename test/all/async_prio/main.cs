...
public static class main
{
	...
	using(dzn.pump pump = new dzn.pump()) {
	    async_prio sut = new async_prio(loc.set(rt).set(pump));
	    ...
	    sut.p.outport.ping = () => {System.Console.Error.WriteLine("sut.p.ping -> <external>.p.ping [" + t + "]");};
