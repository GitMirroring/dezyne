...
DEVELOPMENT:=$(shell readlink -f $(dir $(filter %/build.c++03.make,$(MAKEFILE_LIST)))../../)
define CHECKPARAM
...
CPPFLAGS=-DBOOST_THREAD_PROVIDES_FUTURE -I$(OUT) -I$(OUT)/.. -I$(OUT)/../.. -I$(IN) -I$(IN)/.. -I$(DEVELOPMENT)/externals/asd_cpp_runtime -D DZN_VERSION_ASSERT=1
