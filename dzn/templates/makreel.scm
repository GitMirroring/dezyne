...
;;comonent behavior
(define-templates component-behavior-rename-requires ast:requires+async-port* newline-comma-infix)
...
(define-templates semantics-provides-blocked-qmt ast:requires-port* newline-union-prefix)
(define-templates semantics-provides-blocked-qmt-async ast:async-port* newline-union-prefix)
...
(define-templates semantics-requires-flush ast:provides-port* newline-union-prefix)
