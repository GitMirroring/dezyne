...
(define-templates reply-values ast:provides-ports newline-comma-infix)
...
;;comonent behavior
(define-templates component-behavior-rename-requires ast:requires+async-ports newline-comma-infix)
...
(define-templates semantics-provides-reply-init ast:provides-ports comma-infix)
...
(define-templates semantics-provides-blocked-replies ast:provides-ports newline-union-prefix)
(define-templates semantics-provides-blocked-ports ast:provides-ports newline-union-prefix)
...
(define-templates semantics-reply ast:provides-ports newline-union-infix)
(define-templates semantics-blocked-rtc-provides ast:provides-ports newline-union-infix)
(define-templates semantics-blocked-rtc-requires ast:requires-ports newline-union-prefix)
...
(define-templates reordered ast:provides-ports union-infix)
