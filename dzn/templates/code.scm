...
(define-templates typed-event-slot ast:typed-in-triggers)
...
(define-templates main-port-connect-in-typed ast:out-triggers-typed-in-events)
...
(define-templates main-event-map-typed ast:typed-in-triggers event-map-prefix)
...
(define-templates main-event-map-typed-provides-in ast:provides-in-typed-triggers event-map-prefix)
(define-templates main-event-map-void-requires-in code:requires-in-void-returns event-map-prefix)
(define-templates main-event-map-typed-in code:return-values event-map-prefix)
