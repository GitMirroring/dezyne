...
;;; Copyright © 2014, 2018, 2020, 2021, 2022, 2023, 2025, 2026 Rutger (regtur) van Beusekom <rutger@dezyne.org>
...
(define-method (ast:function* (o <interface>)) ((compose ast:function* .behavior) o))
