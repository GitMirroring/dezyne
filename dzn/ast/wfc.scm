...
(define-method (wfc (o <port>))
  (append
   ...
   (if (and (ast:provides? o) (ast:injected? o))
       ...
       '())
   (if (ast:injected? o)
       `(,(wfc-warning o (format #f "injected port `~a' is a deprecated feature" (.name o))))
       '())
...
(define-method (wfc-function (o <function>))
  (append
   ...
   (re-definition o)
   (wfc (.signature o))
   (if (is-a? (.statement o) <compound>) (wfc (.statement o)) '())
   (missing-return o)))
