...
(define-module (dezyne v2.8 services)
...
(define-public dezyne-source-2.8
  (origin
    ...
    (uri (git-reference
          ...
          (commit "2.8.0")))
    (sha256 (base32 "1hjzkigvfx6cisxggzg6avry4arm1z05mgp23i5nrrll14rygwkw"))))

(define-public dezyne-services-2.8
  (package
    (name "dezyne-services-2.8")
    (version "2.8.0")
    (source dezyne-source-2.8)
    (propagated-inputs `(("asd-converter-0.1.5" ,asd-converter-0.1.5)
                         ("bash" ,bash)
...
(define-public dzn-client-tarball-2.8
  (package
    (name "dzn-client-tarball-2.8")
    (version "2.8.0")
    (source  dezyne-source-2.8)
    (native-inputs
...
(define-public node-dzn-2.8
  (package
    (name "node-dzn")
    (version "2.8.0")
    (source #f)
    (native-inputs `(("dzn-client-tarball" ,dzn-client-tarball-2.8)))
    (propagated-inputs `(("bash" ,bash)
                         ("node-dzn-daemon" ,(@ (dezyne v2.8 server) node-dzn-daemon-11))
                         ("node" ,node6)
                         ("node-snapshot" ,node-snapshot)))
    (build-system gnu-build-system)
    (arguments
