...
(define-module (dezyne v2.4 extra)
...
(define-public asd-converter-0.1.3
  (package
    (name "asd-converter-0.1.3")
    (version "0.1.3")
        (source (origin
              (method git-fetch)
              (uri (git-reference (url (string-append git.oban/git "/gen1gen2.git"))
                                  (commit "d88c09949faaa35dcb0280b70783cc3e8936df5a")))
              (sha256 (base32 "03fmmkjm4qij490jimchg4jcma7zgnhrg9w3azwjn43vsc7r7g7y"))))
    (inputs `(("boost" ,boost)
              ("expat" ,expat)))
