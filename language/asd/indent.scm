...
(define *indent* 2)
(define* (indent :optional (level 0) (port (current-input-port)))
  (define* (space :optional (length level)) (display (make-string length #\space)))
...
(define* (indent-string string :optional (level 0))
  (with-output-to-string 
    (lambda () (with-input-from-string string (lambda () (indent level))))))
